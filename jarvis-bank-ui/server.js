...
app.post('/login', async (req, res) => {
  try {
    ...
    res.render('login', { error: 'Backend service unavailable. Is jarvis-bank-backend running on port 9094?' });
  }
});
...
app.listen(PORT, () => {
  console.log(`jarvis-bank (UI) running at http://localhost:${PORT}`);
